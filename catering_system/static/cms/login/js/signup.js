(function ($) {
    ...
    function require(f) {
        var g = {
            ...
            invite: /^[0-9]{8}/,
            username: /^[\u4e00-\u9fa5]{2,3}$/,
            pwd: /^(?!^([0-9]+|[a-zA-Z]+|[!#*_]+)$)^[a-zA-Z0-9!#*_]{6,16}$/,
            s: ''
        };
        this.rules = {
            ...
            isInvite: function (a, b) {
                b = b || " ";
                if (!g.invite.test(a)) return b
            },
...
$(function () {
    $("#aui-btn-reg").click(function () {
        ...
        var username = $("input[id='user-name']").val()
        var pwd = $("input[id='pwd']").val()
        var invite = $("input[id='invite']").val()
        console.log(phone)
        console.log(verify)
        ...
        myajax.post({
            ...
            'success': function (data) {
                if (data['code'] === 200) {
                    myalert.alertSuccessToast('注册成功！')
                    setTimeout(function () {
